...
const User = () => {
    ...
    }, [ page, limit, search, showLoading, hideLoading ]);
                ...
                { users.length > 0 ? (
                    <SharedStyled.TableWrapper>
                        <SharedStyled.TableListWrapper>
                            ...
                            <tbody>
                                    ...
                                    <SharedStyled.TableListBodyRow key={ user.id }>
                                        ...
                                        <SharedStyled.TableListBodyRowData>
                                            <SharedStyled.TableListBodyRowDataActions>
                                                ...
                                                <SharedStyled.TableListBodyRowDataActionButton onClick={ () => { setSelectedUserId(user.id!); setIsDeleteModalOpen(true); } }> <Trash2 size={ 25 } color="#DC143C" /> </SharedStyled.TableListBodyRowDataActionButton>
                                            </SharedStyled.TableListBodyRowDataActions>
                                        </SharedStyled.TableListBodyRowData>
                                ...
                                <SharedStyled.TableListBodyRow>
                                    <SharedStyled.TableListBodyRowData colSpan={ 7 }> </SharedStyled.TableListBodyRowData>
                                </SharedStyled.TableListBodyRow>
                            </tbody>
                        </SharedStyled.TableListWrapper>
                    </SharedStyled.TableWrapper>
                    ...
                    <SharedStyled.TableWrapper>
                        <SharedStyled.TableListWrapper>
                            <thead>
                                <SharedStyled.TableListHeaderRow>
                                    <SharedStyled.TableListHeaderRowColumn> Verifique os dados informados na busca, ou se for a sua primeira vez utilizando a aplicação, realize o cadastro das informações! </SharedStyled.TableListHeaderRowColumn>
                                </SharedStyled.TableListHeaderRow>
                            </thead>

                            <tbody>
                               <SharedStyled.TableListBodyRow>
                                    <SharedStyled.TableListBodyRowData> Nenhum registro encontrado por aqui. </SharedStyled.TableListBodyRowData>
                                </SharedStyled.TableListBodyRow>
                            </tbody>
                        </SharedStyled.TableListWrapper>
                    </SharedStyled.TableWrapper>
